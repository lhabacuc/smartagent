...
class GrokLLM(BaseLLM):
    ...
    def __init__(
        ...
        resolved_api_key = resolve_api_key("grok", api_key, "XAI_API_KEY")
        ...
        self.model = model or resolve_model("grok", "grok-beta")
    ...
    def chat(self, system_prompt: str, user_prompt: str) -> str:
        ...
        try:
            ...
            raise LLMError(f"Erro Grok: {str(e)}")
